...
<div class="clearfix main" role="main">
  <div class="container">
    ...
    <div id="main-content" class="row main-content">
      ...
      <div id="sidebar-first" class="sidebar col-xs-3 site-sidebar-first">
        <div class="row-fluid"><?php print render($page['sidebar_first']); ?></div>
      </div>
      <!-- /#sidebar-first -->
      <?php endif; ?>
      <div id="content" class="mc-content123 span12">
        <div id="content-wrapper" class="content-wrapper0">
      ...
      <div id="sidebar-second" class="sidebar col-xs-3 site-sidebar-second">
