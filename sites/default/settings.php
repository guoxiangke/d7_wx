...
if($_SERVER['SERVER_NAME']=='dev.bae.com')
$databases = array (
  'default' => 
  array (
    'default' => 
...
if($_SERVER['SERVER_NAME']=='wxstaging.yongbuzhixi.com')
$databases = array (
  'default' => 
  array (
    'default' => 
    array (
      'database' => 'guo_wx_staging',
      'username' => 'guo',
      'password' => 'wfKrcRsG7udXcRvZ',
      'host' => 'localhost',
      'port' => '',
...
if($_SERVER['SERVER_NAME']=='yongbuzhixi.duapp.com')
$databases = array (
  'default' => 
  array (
    'default' => 
    array (
      'database' => 'ZpPfBwqsIpdBgqIxLNsg',
 ...
 *
 */
$drupal_hash_salt = 'noN3-nn6RJeFi--cFf3-rgj1kPMHt77E7h8ViMK7CzI';
